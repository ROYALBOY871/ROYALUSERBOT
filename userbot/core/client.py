...
class RoyalClient(TelegramClient):
    def royal_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**royalBot Error report**\n\n"
                        link = "[here](https://t.me/ROYALUSERBOT)"
            ...
            if pattern is not None:
                ...
                royal.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                royal.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                royal.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
RoyalClient.fast_download_file = download_file
RoyalClient.fast_upload_file = upload_file
RoyalClient.reload = restart_script
RoyalClient.get_msg_link = get_message_link
RoyalClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    RoyalClient.send_message = send_message
    RoyalClient.send_file = send_file
    RoyalClient.edit_message = edit_message
