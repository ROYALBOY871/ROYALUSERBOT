...
__author__ = "RoyalBot <https://github.com/ROYALBOY871/Userbot>"
__copyright__ = f"LegendBot Copyright (C) 2020 - 2021  { __author__}"

royal.version = __version__
royal.tgbot.version = __version__
...
if Config.UPSTREAM_REPO == "pro":
    UPSTREAM_REPO_URL = "https://github.com/ROYALBOY871/Userbot"
