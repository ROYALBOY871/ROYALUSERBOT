...
from ..core.session import royal
from ..helpers import *
from ..helpers.utils import _format, _royaltools, _royalutils, install_pip, reply_id

# =================== CONSTANT ===================
bot = ROYALẞØT
LOGS = logging.getLogger(__name__)
USERID = royal.uid if Config.OWNER_ID == 0 else Config.OWNER_ID
...
ROYAL_USER = royal.me.first_name
ROYAL_Boy = royal.uid
royal_mention = f"[{ROYAL_USER}](tg://user?id={ROYAL_Boy})"
...
# channel
my_channel = Config.YOUR_CHANNEL or "ROYALUSERBOT_SUPPORT"
my_group = Config.YOUR_GROUP or "ROYALUSERBOT"
if "@" in my_channel:
...
# My Channel
chnl_link = "https://t.me/ROYALUSERBOT"
Legend_channel = f"[ROYALẞØT ]({chnl_link})"
grp_link = "https://t.me/ROYALUSERBOT_SUPPORT"
ROYAL_grp = f"[ROYALẞØT ]({grp_link})"
