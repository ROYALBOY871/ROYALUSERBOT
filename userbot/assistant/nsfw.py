...
@royal.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_true")))
async def age_verification_true(event: CallbackQuery):
    ...
    try:
        ...
        await event.edit(
            ...
            file="https://te.legra.ph/file/f1aa375f55fa02ee4314d.jpg",
            buttons=buttons,
        )
...
@royal.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_false")))
...
@royal.tgbot.on(CallbackQuery(data=re.compile(r"^chg_of_decision_")))
